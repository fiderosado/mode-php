...
?>
<main class="flex min-h-screen items-center justify-center bg-[#f8f9fa] px-4">
    <div class="w-full max-w-[420px] rounded-2xl bg-white px-10 py-12">
        ...
        <a id="google-login-button" href="https://accounts.google.com/signin" class="mb-6 flex w-full items-center justify-center gap-3 rounded-lg border border-[#dadce0] bg-white px-6 py-3 text-sm font-medium text-[#3c4043] no-underline transition-all hover:border-[#d2e3fc] hover:bg-[#f8fbff] hover:shadow-sm">
